...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/edman/.eclipse/org.eclipse.platform_3.7.0_1543616141/plugins/org.eclim_1.7.4'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/edman/.eclipse/org.eclipse.platform_3.7.0_1543616141'
  if has('win32unix')
